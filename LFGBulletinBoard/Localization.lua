...
GBB.locales = {
	enGB = {
		...
		["CboxShowTotalTime"]="Show total time",
		["CboxOnDebug"]="Show debug information",
		["CboxNotifyChat"]="Chat Notifications",
		["CboxNotifySound"]="Sound Notifications",
		["CboxCharFilterLevel"]="Recommended level range filter",
		["CboxColorOnLevel"]="Dungeon level colors",
		...
		["CboxEnableShowOnly"]="Results cap for each dungeon",
		["CboxChatStyle"]="Alternative Layout",
		["CboxCharDontFilterOwn"]="Don't filter own request",		  
		["CboxDontTrunicate"]="Disable truncation",
		["CboxOneLineNotification"]="Small one line chat notification",
		["CboxCompactStyle"]="Two line layout",
